...
const AboutPage =() =>{
    return(
        <div>
            ...
            <p>Vivekanand college stands as beacon of knowledge and integrity, committed to delivering tranformative education since its inception in [year of Eatablishment,e.g 1980]our collge has conistently strived to uphold the higest standards of academic rigor and ethical values.</p>
            <h2>Our Mission </h2>
            <ul>
